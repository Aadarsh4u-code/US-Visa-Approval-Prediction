...
class DataTransformation:
    def __init__(self, data_ingestion_artifact: DataIngestionArtifact, 
        ...
        data_validation_artifact: Output reference of data that a validated
        ...
        try:
            ...
            preprocessor = ColumnTransformer(
                [
                    ...
                    ("StandardScalar", numerical_transformer, num_features)
                ]
            )
    ...
    def initiate_data_transformation(self, ) -> DataTransformationArtifact:
        ...
        try:
            if self.data_validation_artifact.validation_status:
                ...
                logging.info("Transformed Target Value Mapping got Training Data.")
                ...
                logging.info("Transformed Target Value Mapping got Testing Data.")

                logging.info("Got train features and test features of dataset")
                ...
                logging.info("Applied SMOTEENN on training dataset to handle Imbalance")

                input_feature_test_final, target_feature_test_final = smt.fit_resample(
                    input_feature_test_arr, target_feature_test_df
                )
                logging.info("Applying SMOTEENN on testing dataset to handle Imbalance")
