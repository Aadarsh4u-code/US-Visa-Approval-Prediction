...
list_of_files = [
    ...
    f"{notebook}/basic_data_inspection.py",
    f"{notebook}/univariate_analysis.py",
    f"{notebook}/bivariate_analysis.py",
    f"{notebook}/multivariate_analysis.py",
    f"{notebook}/missing_value_analysis.py",
    f"{notebook}/outliers_value_analysis.py",
